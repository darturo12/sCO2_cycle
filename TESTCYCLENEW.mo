...
model TESTCYCLENEW
  ...
  Modelica.Fluid.Sources.MassFlowSource_h sinkCold(replaceable package Medium = MediumHot, m_flow = -3345, nPorts = 1, use_m_flow_in = false) annotation(
  ...
  sCO2_cycle.Coller2 coller2(fixed_m_flow = true)  annotation(
    Placement(visible = true, transformation(origin = {-6, -64}, extent = {{-12, -12}, {12, 12}}, rotation = 180)));
equation
  ...
  connect(coller2.port_c_in, Turbi.port_b) annotation(
    Line(points = {{6, -58}, {50, -58}, {50, -54}, {50, -54}}, color = {0, 127, 255}));
  connect(coller2.port_c_out, compressor.port_a) annotation(
    Line(points = {{-18, -58}, {-44, -58}, {-44, -12}, {-44, -12}}, color = {0, 127, 255}));
  connect(sourceCold.ports[1], coller2.port_h_in) annotation(
    Line(points = {{-56, -76}, {-18, -76}, {-18, -70}, {-18, -70}}, color = {0, 127, 255}));
  connect(coller2.port_h_out, sinkCold.ports[1]) annotation(
    Line(points = {{6, -70}, {54, -70}, {54, -72}, {54, -72}}, color = {0, 127, 255}));
  annotation(
