...
SI.SpecificEnthalpy h_in;
  ...
  Modelica.Blocks.Interfaces.RealInput Tamb annotation (Placement(
        ...
        rotation=-90,
        origin={0,78})));
  Modelica.Fluid.Interfaces.FluidPort_a fluid_a(redeclare package Medium=MediumHTF) annotation(
    Placement(visible = true, transformation(extent = {{10, -100}, {30, -80}}, rotation = 0), iconTransformation(extent = {{10, -100}, {30, -80}}, rotation = 0)));
  Modelica.Fluid.Interfaces.FluidPort_b fluid_b(redeclare package Medium=MediumHTF) annotation(
    Placement(visible = true, transformation(extent = {{24, 38}, {44, 58}}, rotation = 0), iconTransformation(extent = {{24, 38}, {44, 58}}, rotation = 0)));
  Modelica.Thermal.HeatTransfer.Interfaces.HeatPort_b heat annotation(
    Placement(visible = true, transformation(extent = {{-110, 20}, {-90, 40}}, rotation = 0), iconTransformation(extent = {{-110, 20}, {-90, 40}}, rotation = 0)));
protected
  ...
  parameter MediumHTF.ThermodynamicState state_0=Medium.setState_pTX(1e5,T_0);
...
equation
  ...
  fluid_a.h_outflow=0;
T_out=Medium_A.temperature(Medium_A.setState_phX(fluid_a.p,fluid_b.h_outflow));
  heat.T=medium.T;
