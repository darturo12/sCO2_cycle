...
model CSP
  ...
  Modelica.Fluid.Sources.Boundary_pT Sourc(redeclare package Medium = MediumHTF, T = 720 + 273.15, nPorts = 1, p = 1e5, use_p_in = false) annotation(
    Placement(visible = true, transformation(origin = {-72, -92}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  sCO2_cycle.CYCLESIMPLE cyclesimple annotation(
    Placement(visible = true, transformation(origin = {83.267, 4.73267}, extent = {{-37.2673, -31.9434}, {42.5912, 37.2673}}, rotation = 0)));
equation
  ...
  connect(receiver.fluid_b, cyclesimple.port_a) annotation(
    Line(points = {{-22, 30}, {57, 30}, {57, 17}}, color = {0, 127, 255}));
  connect(sinkHot.ports[1], cyclesimple.port_b) annotation(
    Line(points = {{62, -60}, {96, -60}, {96, -22}, {72, -22}, {72, -2}, {57, -2}}, color = {0, 127, 255}));
  connect(Sourc.ports[1], receiver.fluid_a) annotation(
    Line(points = {{-62, -92}, {-24, -92}, {-24, 6}}, color = {0, 127, 255}));
protected
  annotation(
