...
parameter Integer N=8;
	...
	parameter SI.TemperatureDifference LMTD_des = -542.936 "Logarithmic mean temperature difference at design";
	...
	parameter SI.Temperature T_a_in_des = from_degC(100) "Cold stream outlet temperature at design";
	parameter SI.Temperature T_a_out_des = from_degC(50) "Cold stream outlet temperature at design";
	parameter SI.Temperature T_b_in_des = from_degC(30) "Cold stream outlet temperature at design";
	parameter SI.Temperature T_b_out_des = from_degC(80) "Cold stream outlet temperature at design";
...
//Declaracion de Temperaturas 
	SI.Temperature T_a_in "Hot stream inlet temperature";
...
equation
	...
	//port_b_out.h_outflow=Medium_B.specificEnthalpy(state_b_out);
	...
	m_flow_air=Q_flow/(port_b_out.h_outflow - inStream(port_b_in.h_outflow));
