...
model NEWTURBINE "Steam turbine"
...
/************************* VARIABLES ****************************/
  ...
  Modelica.Fluid.Interfaces.FluidPort_a inlet(redeclare package Medium=Medium) annotation(
    Placement(visible = true, transformation(origin = {-53, 68}, extent = {{-23, -18}, {23, 18}}, rotation = 0), iconTransformation(origin = {-53, 68}, extent = {{-23, -18}, {23, 18}}, rotation = 0)));
  Modelica.Fluid.Interfaces.FluidPort_b outlet(redeclare package Medium=Medium) annotation(
    Placement(visible = true, transformation(origin = {71, 65}, extent = {{-19, -17}, {19, 17}}, rotation = 0), iconTransformation(origin = {71, 65}, extent = {{-19, -17}, {19, 17}}, rotation = 0)));
equation
...
/* BOUNDARY CONDITIONS */
 ...
 annotation(
    Icon(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}}), graphics = {Polygon(points = {{-28, 76}, {-28, 28}, {-22, 28}, {-22, 82}, {-60, 82}, {-60, 76}, {-28, 76}}, lineColor = {0, 0, 0}, lineThickness = 0.5, fillColor = {0, 0, 0}, fillPattern = FillPattern.Solid), Polygon(points = {{26, 56}, {32, 56}, {32, 76}, {60, 76}, {60, 82}, {26, 82}, {26, 56}}, lineColor = {0, 0, 0}, lineThickness = 0.5, fillColor = {0, 0, 0}, fillPattern = FillPattern.Solid), Rectangle(extent = {{-60, 8}, {60, -8}}, lineColor = {0, 0, 0}, fillPattern = FillPattern.Sphere, fillColor = {160, 160, 164}), Polygon(points = {{-28, 28}, {-28, -26}, {32, -60}, {32, 60}, {-28, 28}}, lineColor = {0, 0, 0}, lineThickness = 0.5, fillColor = {135, 135, 135}, fillPattern = FillPattern.Solid), Text(extent = {{-120, -64}, {138, -104}}, textString = "%name"), Text(extent = {{-74, -48}, {-38, -64}}, lineColor = {0, 0, 255}, textString = "PartialArc")}),
