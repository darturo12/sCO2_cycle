...
parameter Integer N=8;
	...
	parameter SI.Pressure p_b_des = 25e6 "Cold stream pressure";
	parameter SI.Temperature T_a_in_des = from_degC(715) "Cold stream outlet temperature at design";
	parameter SI.Temperature T_a_out_des = from_degC(290) "Cold stream outlet temperature at design";
...
equation
	...
	port_a_out.h_outflow = Medium_A.specificEnthalpy(Medium_A.setState_pTX(port_a_in.p,T_a_out));
