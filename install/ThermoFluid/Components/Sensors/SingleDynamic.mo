package SingleDynamic "Sensors for single component, dynamic flow" 
  ...
  model PressureGauge_bar "Measures pressure relative to atmospheric"
    ...
    extends PartialComponents.Sensors.AbsoluteD;
...
<li><i>December 8, 2000</i>
  ...
  model PressureDiff_Pa "Measures pressure difference"
    ...
    extends PartialComponents.Sensors.ParallellD;
    annotation (Documentation(info="
<HTML>
<p>
...
<li><i>December 8, 2000</i>
  ...
  model MassFlow
    ...
    extends PartialComponents.Sensors.SeriesD;
    annotation (Documentation(info="
<HTML>
<p>
