package MultiStatic "Sensors for multi component, static flow" 
  ...
  model PressureGauge_bar "Measures pressure relative to atmospheric"
    extends Icons.MultiStatic.RotSensorOnePortA(nspecies=4);
...
<li><i>December 8, 2000</i>
  ...
  model PressureDiff_Pa "Measures pressure difference"
    extends Icons.MultiStatic.RotSensorTwoPortBA(nspecies=4);
...
<li><i>December 8, 2000</i>
  ...
  model MassFlow
    extends Icons.MultiStatic.RotSensorTwoPortAB(nspecies=4);
