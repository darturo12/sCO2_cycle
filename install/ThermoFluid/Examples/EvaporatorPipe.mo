model EvaporatorPipe 
  ThermoFluid.Components.Water.Pipes.PipeDS Pipe(n=15, HeatRes(k=5000)) 
    annotation (extent=[-20, -20; 20, 20]);
  ThermoFluid.Components.Water.Reservoirs.WaterSourceS_ph Source(h0=430e3, dp0
      =5.0e3) annotation (extent=[-80, -20; -40, 20]);
  ThermoFluid.Components.Water.Reservoirs.WaterResS_ph Sink(h0=2.7e6) 
