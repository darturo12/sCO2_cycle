model WaterHeatExTestTNSC 
  ...
  Components.Water.Reservoirs.WaterResD_ph Sink2
    annotation (extent=[-40, 60; -80, 100]);
  ...
  Components.Water.HeatExchangers.TubeNShellDC Hex
...
equation 
  ...
  connect(Hex.c2, Sink2.a) annotation (points=[-40, 80; -24, 80; -24, 40]);
  connect(Source2.b, Hex.c1) annotation (points=[24, -40; 24, -60; 60, -60]);
end WaterHeatExTestTNSC;
