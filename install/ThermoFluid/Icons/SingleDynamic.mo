package SingleDynamic 
  ...
  partial model PartialTwoPortBB 
    ...
    Interfaces.SingleDynamic.FlowB a annotation (extent=[-110, -10; -90, 10]);
    Interfaces.SingleDynamic.FlowB b annotation (extent=[90, -10; 110, 10]);
  ...
  partial model ReservoirA 
    ...
    replaceable Interfaces.SingleDynamic.FlowA a annotation (extent=[-110, -10
          ; -90, 10]);
  ...
  partial model ReservoirB 
    ...
    parameter String str1="p";
    parameter String str2="T";
    replaceable Interfaces.SingleDynamic.FlowB b annotation (extent=[90, -10; 
          110, 10]);
    Modelica.Blocks.Interfaces.InPort inp1 annotation (extent=[-60, 100; -40, 
          80], rotation=90);
    Modelica.Blocks.Interfaces.InPort inp2 annotation (extent=[40, 100; 60, 80]
  ...
  partial model Volume 
    ...
    Interfaces.SingleDynamic.FlowA a annotation (extent=[-110, -10; -90, 10]);
    Interfaces.SingleDynamic.FlowA b annotation (extent=[90, -10; 110, 10]);
  ...
  partial model Condenser 
    ...
    Interfaces.SingleDynamic.FlowA a annotation (extent=[-10, 90; 10, 110]);
    Interfaces.SingleDynamic.FlowA b annotation (extent=[-10, -110; 10, -90]);
    annotation (
  ...
  partial model CondenserAB 
    extends Images.Condenser;
    Interfaces.SingleDynamic.FlowA a annotation (extent=[-10, 90; 10, 110]);
    Interfaces.SingleDynamic.FlowB b annotation (extent=[-10, -110; 10, -90]);
    annotation (
      Icon(Line(points=[0, 100; 0, 60], style(color=0)), Line(points=[0, -100
              ; 0, -60], style(color=0))));
  end CondenserAB;
  ...
  partial model Boiler 
    ...
    Interfaces.SingleDynamic.FlowA a annotation (extent=[-110, -50; -90, -30])
      ;
    Interfaces.SingleDynamic.FlowB b annotation (extent=[90, 70; 110, 90]);
    annotation (
  ...
  partial model IdealThreePort 
    ...
    Interfaces.SingleDynamic.FlowA a annotation (extent=[-110, -10; -90, 10]);
    Interfaces.SingleDynamic.FlowA b annotation (extent=[90, -10; 110, 10]);
    Interfaces.SingleDynamic.FlowA c annotation (extent=[-10, -110; 10, -90]);
    annotation (Icon(
  ...
  partial model ThreePortSplit 
    extends Images.ThreePort;
    Interfaces.SingleDynamic.FlowA a annotation (extent=[90, -10; 110, 10]);
    Interfaces.SingleDynamic.FlowB b annotation (extent=[-110, -10; -90, 10]);
    Interfaces.SingleDynamic.FlowB c annotation (extent=[-10, -110; 10, -90]);
    annotation (Icon(
        Line(points=[0, -70; 0, -100], style(color=0)), 
        Line(points=[-80, 0; -100, 0], style(color=0)), 
        Line(points=[80, 0; 100, 0], style(color=0))));
  ...
  partial model Pipe2HT 
    extends Images.Pipe;
    parameter Integer n(min=1) "discretization number";
    Interfaces.SingleDynamic.FlowA a annotation (extent=[-
          110, -10; -90, 10]);
    Interfaces.SingleDynamic.FlowB b annotation (extent=[90
          , -10; 110, 10]);
  ...
  partial model RotSensorOnePortA 
    ...
    Interfaces.SingleDynamic.FlowA a annotation (extent=[-10, -110; 10, -90]);
  ...
  partial model Hex 
    ...
    Interfaces.SingleDynamic.FlowA h1 annotation (extent=[-110, 60; -90, 80]);
    Interfaces.SingleDynamic.FlowB h2 annotation (extent=[90, 60; 110, 80]);
    Interfaces.SingleDynamic.FlowA c1 annotation (extent=[-110, -80; -90, -60]
      );
    Interfaces.SingleDynamic.FlowB c2 annotation (extent=[90, -80; 110, -60]);
  end Hex;
  ...
  partial model HexC 
    ...
    Interfaces.SingleDynamic.FlowA h1 annotation (extent=[-110, 60; -90, 80]);
    Interfaces.SingleDynamic.FlowB h2 annotation (extent=[90, 60; 110, 80]);
    Interfaces.SingleDynamic.FlowA c1 annotation (extent=[90, -80; 110, -60]);
    Interfaces.SingleDynamic.FlowB c2 annotation (extent=[-110, -80; -90, -60]
      );
  end HexC;
  ...
  partial model TnSh 
    ...
    Interfaces.SingleDynamic.FlowA h1 annotation (extent=[-110, -10; -90, 10])
      ;
    Interfaces.SingleDynamic.FlowB h2 annotation (extent=[90, -10; 110, 10]);
    Interfaces.SingleDynamic.FlowA c1 annotation (extent=[-70, 90; -50, 110]);
    Interfaces.SingleDynamic.FlowB c2 annotation (extent=[50, -110; 70, -90]);
  end TnSh;
  ...
  partial model TnShC 
    ...
    Interfaces.SingleDynamic.FlowA h1 annotation (extent=[-110, -10; -90, 10])
      ;
    Interfaces.SingleDynamic.FlowB h2 annotation (extent=[90, -10; 110, 10]);
    Interfaces.SingleDynamic.FlowA c1 annotation (extent=[50, -110; 70, -90]);
    Interfaces.SingleDynamic.FlowB c2 annotation (extent=[-70, 90; -50, 110]);
  end TnShC;
  ...
  partial model TurbineStage 
    ...
    Interfaces.SingleDynamic.FlowB a annotation (extent=[-110, 90; -90, 70]);
    Interfaces.SingleDynamic.FlowB b annotation (extent=[90, -70; 110, -90]);
  ...
  partial model Turbine 
    ...
    Interfaces.SingleDynamic.FlowA a annotation (extent=[-110, 90; -90, 70]);
    Interfaces.SingleDynamic.FlowB b annotation (extent=[90, -70; 110, -90]);
    annotation (Icon(Line(points=[-100, 80; -60, 80; -60, 40], style(color=0))
          , Line(points=[100, -80; 60, -80], style(color=0))));
  end Turbine;
  ...
  partial model RadialCompressor 
    ...
    Interfaces.SingleDynamic.FlowB a annotation (extent=[-110, -10; -90, 10]);
    Interfaces.SingleDynamic.FlowB b annotation (extent=[90, 60; 110, 40]);
