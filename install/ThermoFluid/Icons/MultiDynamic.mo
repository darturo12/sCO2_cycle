package MultiDynamic 
  ...
  //Changed by Jonas : 2001-07-27 at 17.00 (new heatconn. graphics)
  ...
  partial model PartialTwoPortBB 
    ...
    Interfaces.MultiDynamic.FlowB a(nspecies=nspecies) annotation (extent=[-
          110, -10; -90, 10]);
    Interfaces.MultiDynamic.FlowB b(nspecies=nspecies) annotation (extent=[90
          , -10; 110, 10]);
  ...
  partial model ReservoirA 
    ...
    replaceable Interfaces.MultiDynamic.FlowA a(nspecies=nspecies)
  ...
  partial model ReservoirB 
    ...
    parameter String str2="T";
    parameter String str3="X";
    replaceable Interfaces.MultiDynamic.FlowB b(nspecies=nspecies)
  ...
  partial model Volume 
    ...
    parameter Integer nspecies(min=1);
    Interfaces.MultiDynamic.FlowA a(nspecies=nspecies) annotation (extent=[-
          110, -10; -90, 10]);
    Interfaces.MultiDynamic.FlowA b(nspecies=nspecies) annotation (extent=[90
          , -10; 110, 10]);
  ...
  partial model IdealThreePort 
    ...
    Interfaces.MultiDynamic.FlowA b(nspecies=nspecies) annotation (extent=[90
          , -10; 110, 10]);
    Interfaces.MultiDynamic.FlowA c(nspecies=nspecies) annotation (extent=[-10
          , -110; 10, -90]);
    annotation (Icon(
  ...
  partial model ThreePortSplit 
    ...
    Interfaces.MultiDynamic.FlowA b(nspecies=nspecies) annotation (extent=[90
          , -10; 110, 10]);
    Interfaces.MultiDynamic.FlowB c(nspecies=nspecies) annotation (extent=[-10
          , -110; 10, -90]);
    annotation (Icon(
        Line(points=[0, -70; 0, -100], style(color=0)), 
        Line(points=[-80, 0; -100, 0], style(color=0)), 
  ...
  partial model RotSensorOnePortA 
    ...
    parameter Integer nspecies(min=1);
    Interfaces.MultiDynamic.FlowA a(nspecies=nspecies) annotation (extent=[-10
          , -110; 10, -90]);
  ...
  partial model Hex 
    ...
    parameter Integer nspecies(min=1);
    Interfaces.MultiDynamic.FlowA h1(nspecies=nspecies) annotation (extent=[-
          110, 60; -90, 80]);
    Interfaces.MultiDynamic.FlowB h2(nspecies=nspecies) annotation (extent=[90
          , 60; 110, 80]);
    Interfaces.MultiDynamic.FlowA c1(nspecies=nspecies) annotation (extent=[-
          110, -80; -90, -60]);
    Interfaces.MultiDynamic.FlowB c2(nspecies=nspecies) annotation (extent=[90
          , -80; 110, -60]);
  end Hex;
  ...
  partial model HexC 
    ...
    Interfaces.MultiDynamic.FlowB h2(nspecies=nspecies) annotation (extent=[90
          , 60; 110, 80]);
    Interfaces.MultiDynamic.FlowA c1(nspecies=nspecies) annotation (extent=[90
          , -80; 110, -60]);
    Interfaces.MultiDynamic.FlowB c2(nspecies=nspecies) annotation (extent=[-
          110, -80; -90, -60]);
  end HexC;
  ...
  partial model TnSh 
    ...
    Interfaces.MultiDynamic.FlowA c1(nspecies=nspecies) annotation (extent=[-
          70, 90; -50, 110]);
    Interfaces.MultiDynamic.FlowB c2(nspecies=nspecies) annotation (extent=[50
          , -110; 70, -90]);
  end TnSh;
  ...
  partial model TnShC 
    ...
    Interfaces.MultiDynamic.FlowB h2(nspecies=nspecies) annotation (extent=[90
          , -10; 110, 10]);
    Interfaces.MultiDynamic.FlowA c1(nspecies=nspecies) annotation (extent=[50
          , -110; 70, -90]);
    Interfaces.MultiDynamic.FlowB c2(nspecies=nspecies) annotation (extent=[-
          70, 90; -50, 110]);
  end TnShC;
  ...
  partial model TurbineStage 
    ...
    Interfaces.MultiDynamic.FlowB a annotation (extent=[-110, 90; -90, 70]);
    Interfaces.MultiDynamic.FlowB b annotation (extent=[90, -70; 110, -90]);
  ...
  partial model Turbine 
    ...
    Interfaces.MultiDynamic.FlowA a annotation (extent=[-110, 90; -90, 70]);
    Interfaces.MultiDynamic.FlowB b annotation (extent=[90, -70; 110, -90]);
    annotation (Icon(Line(points=[-100, 80; -60, 80; -60, 40], style(color=0))
          , Line(points=[100, -80; 60, -80], style(color=0))));
  end Turbine;
  ...
  partial model PumpStage 
    ...
    Interfaces.MultiDynamic.FlowB a annotation (extent=[-110, -10; -90, 10]);
    Interfaces.MultiDynamic.FlowB b annotation (extent=[90, 10; 110, -10]);
  ...
  partial model Pump 
    extends Images.Pump;
    Interfaces.MultiDynamic.FlowA a annotation (extent=[-110, -10; -90, 10]);
    Interfaces.MultiDynamic.FlowB b annotation (extent=[90, 10; 110, -10]);
    annotation (extent=[-10, 90; 10, 110], rotation=-90);
    annotation (Icon(Line(points=[-100, 0; -80, 0], style(color=0)), Line(
            points=[80, 0; 100, 0], style(color=0))));
