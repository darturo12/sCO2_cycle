...
parameter Integer N=8;
	...
	parameter SI.Pressure p_b_des = 24e6 "Cold stream pressure";
	parameter SI.Temperature T_a_in_des = from_degC(500) "Cold stream outlet temperature at design";
	parameter SI.Temperature T_a_out_des = from_degC(300) "Cold stream outlet temperature at design";
	parameter SI.Temperature T_b_in_des = from_degC(200) "Cold stream outlet temperature at design";
