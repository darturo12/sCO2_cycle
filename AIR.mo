...
//	import SolarTherm.Media.ChlorideSaltPH.ChlorideSaltPH_utilities.*;
	...
	*/
	...
	equation
	T = stprops("T","P",p,"H",h,"R729");
	p = state.p;
	d = stprops("D","P",p,"H",h,"R729");
	h = state.h;
	u = stprops("U","P",p,"H",h,"R729");
	MM = 0.044;
	R = 8.3144 / MM;
	...
	*/
	...
	algorithm
		state := ThermodynamicState(p=p, h=stprops("H","T",T,"P",p,"R729"));
	end setState_pTX;
	...
	output ThermodynamicState state "Thermodynamic state record";
	algorithm
		state := ThermodynamicState(p=p, h=stprops("H","P",p,"S",s,"729"));
	end setState_psX;
	...
	redeclare function setState_dTX
		...
		output ThermodynamicState state "Thermodynamic state record";
	algorithm
		state := ThermodynamicState(p=stprops("P","T",T,"D",d,"729"), h=stprops("H","T",T,"D",d,"729"));
	end setState_dTX;
	...
	algorithm
		T := stprops("T","P",state.p,"H",state.h,"729");
		annotation (Inline=true);
	end temperature;
	...
	algorithm
		d := stprops("D","P",state.p,"H",state.h,"R729");
		annotation (Inline=true);
	end density;

	redeclare function extends specificInternalEnergy "Return specific internal energy"
	algorithm
		u := stprops("U","P",state.p,"H",state.h,"R729");
		annotation (Inline=true);
	end specificInternalEnergy;

	redeclare function extends thermalConductivity "Return thermal conductivity"
	algorithm
		lambda := stprops("L","P",state.p,"H",state.h,"R729");
		annotation (Documentation(info="<html>
	...
	algorithm
		s := stprops("S","P",state.p,"H",state.h,"R729");
		annotation (Documentation(info="<html>
	...
	algorithm
		g := stprops("G","P",state.p,"H",state.h,"R729");
		annotation (Documentation(info="<html>
	...
	algorithm
		f := stprops("HELMHOLTZMASS","P",state.p,"H",state.h,"729");
		annotation (Documentation(info="<html>
	...
	algorithm
		cp := stprops("C","P",state.p,"H",state.h,"R729");
		annotation (Documentation(info="<html>
	...
	algorithm
		cv := stprops("CVMASS","P",state.p,"H",state.h,"R729");
		annotation (Documentation(info="<html>
	...
	algorithm
		ddTp := stprops("d(D)/d(T)|P","P",state.p,"H",state.h,"R729");
		annotation (Documentation(info="<html>
